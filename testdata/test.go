...
func testInvalid(t *proto.Test) {
	func(...interface{}) {}(t.B, t.D)      // want `avoid direct access to proto field t\.B, use t\.GetB\(\) instead` `avoid direct access to proto field t\.D, use t\.GetD\(\) instead`
	...
	_ = t.Embedded.S                                    // want `avoid direct access to proto field t\.Embedded, use t\.GetEmbedded\(\) instead` `avoid direct access to proto field t\.Embedded\.S, use t\.Embedded\.GetS\(\) instead`
	_ = t.GetEmbedded().S                               // want `avoid direct access to proto field t\.GetEmbedded\(\)\.S, use t\.GetEmbedded\(\)\.GetS\(\) instead`
	_ = t.Embedded.Embedded                             // want `avoid direct access to proto field t\.Embedded, use t\.GetEmbedded\(\) instead` `avoid direct access to proto field t\.Embedded\.Embedded, use t\.Embedded\.GetEmbedded\(\) instead`
	...
	_ = t.Embedded.Embedded.S                           // want `avoid direct access to proto field t\.Embedded, use t\.GetEmbedded\(\) instead` `avoid direct access to proto field t\.Embedded\.Embedded, use t\.Embedded\.GetEmbedded\(\) instead` `avoid direct access to proto field t\.Embedded\.Embedded\.S, use t\.Embedded\.Embedded.GetS\(\) instead`
	...
	_ = t.RepeatedEmbeddeds[0].S                        // want `avoid direct access to proto field t\.RepeatedEmbeddeds, use t\.GetRepeatedEmbeddeds\(\) instead` `avoid direct access to proto field t\.RepeatedEmbeddeds\[0\]\.S, use t\.RepeatedEmbeddeds\[0\]\.GetS\(\) instead`
	...
	_ = t.RepeatedEmbeddeds[0].Embedded                 // want `avoid direct access to proto field t\.RepeatedEmbeddeds, use t\.GetRepeatedEmbeddeds\(\) instead` `avoid direct access to proto field t\.RepeatedEmbeddeds\[0\]\.Embedded, use t\.RepeatedEmbeddeds\[0\]\.GetEmbedded\(\) instead`
	...
	_ = t.RepeatedEmbeddeds[0].Embedded.S               // want `avoid direct access to proto field t\.RepeatedEmbeddeds, use t\.GetRepeatedEmbeddeds\(\) instead` `avoid direct access to proto field t\.RepeatedEmbeddeds\[0\]\.Embedded, use t\.RepeatedEmbeddeds\[0\].GetEmbedded\(\) instead` `avoid direct access to proto field t\.RepeatedEmbeddeds\[0\]\.Embedded\.S, use t\.RepeatedEmbeddeds\[0\].Embedded.GetS\(\) instead`
	...
	_ = t.RepeatedEmbeddeds[t.I64].Embedded.S           // want `avoid direct access to proto field t\.RepeatedEmbeddeds, use t\.GetRepeatedEmbeddeds\(\) instead` `avoid direct access to proto field t\.RepeatedEmbeddeds\[t\.I64\].Embedded, use t\.RepeatedEmbeddeds\[t\.I64\].GetEmbedded\(\) instead` `avoid direct access to proto field t\.RepeatedEmbeddeds\[t.I64\]\.Embedded\.S, use t\.RepeatedEmbeddeds\[t.I64\]\.Embedded\.GetS\(\) instead` `avoid direct access to proto field t\.I64, use t\.GetI64\(\) instead`
	_ = t.GetRepeatedEmbeddeds()[t.I64].GetEmbedded().S // want `avoid direct access to proto field t\.GetRepeatedEmbeddeds\(\)\[t\.I64\]\.GetEmbedded\(\)\.S, use t\.GetRepeatedEmbeddeds\(\)\[t\.I64\]\.GetEmbedded\(\).GetS\(\) instead` `avoid direct access to proto field t\.I64, use t\.GetI64\(\) instead`

	var many []*proto.Test
	manyIndex := 42

	_ = many[0].T                   // want `avoid direct access to proto field many\[0\]\.T, use many\[0\]\.GetT\(\) instead`
	_ = many[1].Embedded.S          // want `avoid direct access to proto field many\[1\]\.Embedded, use many\[1\]\.GetEmbedded\(\) instead` `avoid direct access to proto field many\[1\]\.Embedded\.S, use many\[1\]\.Embedded\.GetS\(\) instead`
	_ = many[2].GetEmbedded().S     // want `avoid direct access to proto field many\[2\]\.GetEmbedded\(\)\.S, use many\[2\].GetEmbedded\(\)\.GetS\(\) instead`
	_ = many[3].Embedded.Embedded.S // want `avoid direct access to proto field many\[3\]\.Embedded, use many\[3\].GetEmbedded\(\) instead` `avoid direct access to proto field many\[3\]\.Embedded\.Embedded, use many\[3\].Embedded\.GetEmbedded\(\)\ instead` `avoid direct access to proto field many\[3\]\.Embedded\.Embedded\.S, use many\[3\].Embedded\.Embedded\.GetS\(\) instead`
	_ = many[manyIndex].S           // want `avoid direct access to proto field many\[manyIndex\]\.S, use many\[manyIndex\]\.GetS\(\) instead`

	test := many[0].Embedded.S == "" || t.Embedded.CustomMethod() == nil || t.S == "" || t.Embedded == nil // want `avoid direct access to proto field many\[0\]\.Embedded, use many\[0\]\.GetEmbedded\(\) instead` `avoid direct access to proto field many\[0\]\.Embedded\.S, use many\[0\]\.Embedded.GetS\(\) instead` `avoid direct access to proto field t\.Embedded, use t\.GetEmbedded\(\) instead` `avoid direct access to proto field t\.S, use t\.GetS\(\) instead` `avoid direct access to proto field t\.Embedded, use t\.GetEmbedded\(\) instead`
	_ = test
	...
	_ = (*ptrs)[t.I64].RepeatedEmbeddeds // want `avoid direct access to proto field \(\*ptrs\)\[t\.I64\]\.RepeatedEmbeddeds, use \(\*ptrs\)\[t\.I64\].GetRepeatedEmbeddeds\(\) instead` `avoid direct access to proto field t\.I64, use t\.GetI64\(\) instead`
	...
	t.Embedded.SetS("test")                              // want `avoid direct access to proto field t\.Embedded, use t\.GetEmbedded\(\) instead`
	t.Embedded.SetMap(map[string]string{"test": "test"}) // want `avoid direct access to proto field t\.Embedded, use t\.GetEmbedded\(\) instead`
}
